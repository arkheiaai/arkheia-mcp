...
MUTANTS: list[Mutant] = [
    ...
    Mutant("M36", "startup guard warns instead of refusing to boot",
           ...
           "            pass"),
    Mutant("M37", "stop surfacing a URL-without-secret rail at startup",
           "    if url_set and not secret_set:", "    if False:"),
    Mutant("M40", "stop surfacing a secret-without-URL rail at startup",
           "    elif secret_set and not url_set:", "    elif False:"),
